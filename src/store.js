...
export default new Vuex.Store({
  state: {
    savedWords: JSON.parse(localStorage.getItem('savedEDictWords')) || []
  },
  mutations: {
    ...
    REMOVE_SAVED_WORD(state, id) {
      ...
      localStorage.setItem('savedEDictWords', JSON.stringify(keepers))
    },
    REMOVE_ALL_SAVED_WORDS(state) {
      localStorage.removeItem('savedEDictWords')
      state.savedWords = []
    }
  },
  actions: {
