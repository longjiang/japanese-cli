...
import '@/assets/css/japanesezerotohero.css'
import Vue from 'vue'
import BootstrapVue from 'bootstrap-vue'
import JapaneseZeroToHero from './JapaneseZeroToHero'
...
window.japaneseZeroToHeroApp = new Vue({
  router,
  store,
  render: h => h(JapaneseZeroToHero)
}).$mount('#japanesezerotohero')
